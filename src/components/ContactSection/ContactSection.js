  ...
  return (
    <section className="contact">
      ...
      <div className="contact__links-container">
        <a href="https://linkedin.com/in/keith-ryan-orourke" target="_blank" className="contact__link"><img src={linkedinIcon} alt="GitHub icon" className="contact__icon" />Visit my LinkedIn!</a>
